...
always @(fsm_state) begin: CLASSIC_DEBOUNCED_FSM_WITH_COMPARE_LOC_INSTS_CHUNK_INSTS_1_C
    case (fsm_state)
        2'b00: begin
            outputs_o = 1;
        end
...
always @(posedge clk_i) begin: CLASSIC_DEBOUNCED_FSM_WITH_COMPARE_LOC_INSTS_CHUNK_INSTS_3
...
always @(posedge clk_i) begin: CLASSIC_DEBOUNCED_FSM_WITH_COMPARE_LOC_INSTS_CHUNK_INSTS_4_LOC_INSTS_CHUNK_INSTS_0
...
always @(posedge clk_i) begin: CLASSIC_DEBOUNCED_FSM_WITH_COMPARE_LOC_INSTS_CHUNK_INSTS_4_LOC_INSTS_CHUNK_INSTS_K
    if ((chunk_insts_4_debounce_cnt == 0)) begin
...
always @(posedge clk_i) begin: CLASSIC_DEBOUNCED_FSM_WITH_COMPARE_LOC_INSTS_CHUNK_INSTS_K_LOC_INSTS_CHUNK_INSTS_0
...
always @(posedge clk_i) begin: CLASSIC_DEBOUNCED_FSM_WITH_COMPARE_LOC_INSTS_CHUNK_INSTS_K_LOC_INSTS_CHUNK_INSTS_K
